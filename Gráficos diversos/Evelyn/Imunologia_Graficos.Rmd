...
plot_united = (
  ...
  plot_annotation(
    ...
    title = "ELISA OD50",
    subtitle = "ANOVA baseado no modelo linear misto, ajustado por efeito do lote de experimento,\ncom o método de tukey para correção de p-valores.\nSignificance p-value symbols: * = 0.10, ** = 0.05, *** = < 0.01.\nBlack thick lines correspond to the mean."
  )
