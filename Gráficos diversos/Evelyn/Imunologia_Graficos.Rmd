...
ELISA_OD50 <- read_excel(here("Gráficos diversos", "Evelyn", "ELISA_OD50.xlsx"))
...
plot_group = table %>% 
  ...
  ggplot(aes(x = dia, y = valor_log)) +   # 🔑 define as escalas
...
# IgG Subclasses
```{r fig.height=5, fig.width=10}
igg_subclasses <- read_excel(here("Gráficos diversos", "Evelyn", "igg_subclasses.xlsx"))
