...
```{r}
#Importar
citometria_dezembro <- read_excel(here("Gráficos diversos", "Evelyn", "citometria_evelyn_29-12-25.xlsx"))
...
# citometria_plot_CD4 %>%
# ggsave(filename = here("Gráficos diversos", "Citometria_AllvsAll_Welch_GamesHowell_CD4_CD8.png"),
#        width = 10,
#        height = 10,
#        bg = "white")
...
citometria_plot_CD4_CD8_test %>%
ggsave(filename = here("Gráficos diversos", "Evelyn", "Citometria_AllvsAll_Welch_GamesHowell_CD4_CD8.png"),
       width = 12,
       height = 10,
       bg = "white")
